...
const newDatasets = [
	...
	},
	{
		...
		limitations:
			'Current coverage is limited to Marden parish and Golden Valley; additional 1880s OS sheets exist in Maps/1880_6inch/AffineECW.'
	},
	{
		...
		limitations:
			'Current coverage is limited to Marden parish; additional RAF and commercial aerial photos exist in the archive but are not yet georeferenced.'
	}
];
