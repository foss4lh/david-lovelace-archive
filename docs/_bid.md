...
Before he passed away on 5 May 2026, he expressed a clear wish that his
...
> 1.  Which specific parishes, landscapes, or themes (e.g. traditional
>     meadows, ancient trees, parish tithes) represent the highest
>     immediate priority for your organisation?
> 2.  Are there upcoming county initiatives or time-sensitive projects
>     (e.g. Local Nature Recovery Strategy milestones, parkland
>     restorations, forthcoming publications) that this archive should
>     support?
...
```mermaid
flowchart TD
    subgraph Tier1 ["1. Permanent Archive Copies (Hard Disks)"]
        HD1["HARC Deposit"]
        HD2["Woolhope Club Library"]
        HD3["Data Orchard Working Master"]
    end

    subgraph Tier2 ["2. Immediate Direct Downloads"]
        DL["Web Download Portal<br/>(Original Tithe Map Scans, Aerial Photos, Documents)"]
    end

    subgraph Tier3 ["3. Fast Web Map Layers"]
        GIS["Streamable Map Layers<br/>(Instant display in browser, no server fees)"]
    end

    subgraph Tier4 ["4. Public Web Explorer"]
        WEB["Interactive Community Web Map<br/>(Parish search, historical slider, mobile-friendly)"]
    end
...
- Key Outputs:
  ...
  - The David Lovelace Memorial Mapping Workshop: A 1–2 day beginner
    course in Hereford for parish councils, naturalists, and local
    historians (using free QGIS software).
  - Herefordshire Mapathon: A 1-day collaborative community event to
    align historic maps, trace old field boundaries, and record veteran
    trees.
  - Field-checked case studies: 3–4 published examples demonstrating
    practical value (e.g. Wyescapes floodplain meadow recovery, Homme
    House historic parkland, county botanical recording, lost industrial
    mills).
  - Open training packs and step-by-step video guides.
- Skills Required: Digital map alignment, historic landscape
  interpretation, field ground-truthing, training delivery, and event
  facilitation.
- Estimated Resource:
  - People: ~23–25 person-days (technical lead/mentor, mapping
    assistant, field surveyor, workshop facilitator).
  - Hardware & Events: 1x dedicated mapping laptop homed in
...
- Focus: Delivering a fast, easy-to-use online map explorer with parish
  search and direct downloads, designed to run permanently with no
  ongoing server rental fees.
- Key Outputs:
  - Interactive community web map with parish search, map layer
    comparison sliders, and grid reference lookups.
  - Searchable links connecting historic photographs and survey
...
> 2.  What in-kind venue space, volunteer time, or equipment can your
>     organisation offer to help strengthen our match funding?
